...
export default function AboutModal({ onClose, onContactClick }: AboutModalProps) {
  useEffect(() => {
        ...
        <div className="px-8 py-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3 pt-1">
            {[
              ...
              <div key={item.label} className="bg-white border border-[#f1e7d9] rounded-[18px] px-4 py-3.5">
